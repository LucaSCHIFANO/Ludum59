...
public class SoundManager : MonoBehaviour
{
    ...
    public int Play(SOSound sound)
    {
        ...
        var currentPitch = sound.isPitchRandom ? Random.Range(sound.minRandomPitch, sound.MaxRandomPitch) : sound.pitch;
        ...
        newSoundEmitter.AudioSource.volume = sound.isVolumeRandom ? Random.Range(sound.minRandomVolume, sound.MaxRandomVolume) : sound.volume;
